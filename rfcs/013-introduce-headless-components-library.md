...
| Maturity                          | Very recent (introduced Sep 2022), frequent breaking changes, React bindings not production-ready |                                                                                                       |            | Mature (first release Dec 2020)  |        |          |            |
| Maintenance                       |                                                                                                   |                                                                                                       |            | Active                           |        |          |            |
...
| Collapsible                       | ❌                                                                                                | ❌                                                                                                    |            | ✅                               |        |          |            |
| ═════════════                     | ══                                                                                                | ══                                                                                                    | ══         | ══                               | ══     | ══       | ══         |
| Conclusion                        | Not production-ready                                                                              | Only supports a very limited set of components. We'd need to couple it with other component libraries |            |                                  |        |          |            |
